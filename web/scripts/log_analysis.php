...
function show_log_stats() 
{
	...
	$strHTML .= "Approximately ".number_format($BytesPerEvent)." bytes per event.  Instance can store more than ".number_format($MoreEvents)." more events.  There are $num_unique_strings unique strings currently stored.<br>";
