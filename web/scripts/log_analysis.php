...
function show_log_stats() 
{
	...
	$strHTML .= "Approximately ".number_format($BytesPerEvent)." bytes per event.  Instance can store more than ".number_format($MoreEvents)." more events.  There are ".number_format($num_unique_strings)." currently stored.<br>";
